...
public:
	...
	osg::ref_ptr<osgEarth::ModelLayer> ModelLayerManager::changeLayerStyle(
		std::string path, QString gemtype, std::string iconPath, float layerHeight);
	...
	char* getSRS() { return _origlSRS; }

	QString &getGemType() { return _gemtype; }
