...
struct EmptyStringException : std::exception
{
  const char *what() { return "Data::operator[] cannot take an empty string\n"; }
};
...
protected:
  Data(boost::property_tree::ptree &tree, const std::string &key) : tree(&tree),
                                                                    context(""),
                                                                    key(key),
                                                                    path(key)
  {
  ...
  Data(boost::property_tree::ptree &tree, const std::string &context, const std::string &key) : tree(&tree),
                                                                                                context(context),
                                                                                                key(key),
