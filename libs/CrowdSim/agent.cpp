...
Agent::Agent() : Tagent(), _pathIndex(0), _firstShot(true)
{
...
unsigned Ped::Agent::densityCorrection(int planned)
{
	...
	for (int direction = 0; direction < Cell::SELF; direction++)
	{
		...
		{
		case(0):	will = 2.5f; break;
		case(1):	will = 2.0f; break;
		case(2):	will = 1.5f; break;
		case(3):	will = 1.0f; break;
		case(4):	will = 0.5f; break;
		}
